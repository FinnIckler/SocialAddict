...
object BezierSplineUtil {
    ...
    fun getCurveControlPoints(knots: Array<Point>?): Array<Array<Point>> {
        ...
        val n = knots.size - 1
        val firstControlPoints = Array<Point>(knots.size - 1,init = {_ -> Point(0f,0f)})
        val secondControlPoints = Array<Point>(knots.size - 1,init = {_ -> Point(0f,0f)})
        ...
        if (n == 1) {
            ...
            return arrayOf<Array<Point>>(firstControlPoints, secondControlPoints)
        }
